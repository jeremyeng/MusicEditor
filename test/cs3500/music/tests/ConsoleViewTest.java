...
/**
 * A testing class for the console view.
 */
public class ConsoleViewTest {

  IMusicEditorView consoleView;
  MusicEditorModel model;
  MusicEditorController controller;
  CompositionBuilder<IMusicEditor<Note>> builder;
  ...
  public void initData() {
    ...
    consoleView = new ConsoleView(viewOutput);
    model = new MusicEditorModel(100);
    builder = new MusicEditorModel.Builder();
  }

  @Test
  public void testMaryConsoleView() throws IOException {
